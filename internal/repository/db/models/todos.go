...
type Todo struct {
	TodoID      uint64      `boil:"todo_id" json:"todo_id" toml:"todo_id" yaml:"todo_id"`
	...
	DelFlag     bool        `boil:"del_flag" json:"del_flag" toml:"del_flag" yaml:"del_flag"`
...
var TodoTableColumns = struct {
	...
	StatusID:    "todos.status_id",
	DueDate:     "todos.due_date",
	DelFlag:     "todos.del_flag",
	CreateAt:    "todos.create_at",
	UpdateAt:    "todos.update_at",
}
...
var TodoWhere = struct {
	TodoID      whereHelperuint64
	Title       whereHelperstring
	Description whereHelpernull_String
	StatusID    whereHelperuint64
	DueDate     whereHelpernull_Time
	DelFlag     whereHelperbool
	CreateAt    whereHelpertime_Time
	UpdateAt    whereHelpertime_Time
}{
	TodoID:      whereHelperuint64{field: "`todos`.`todo_id`"},
	Title:       whereHelperstring{field: "`todos`.`title`"},
	Description: whereHelpernull_String{field: "`todos`.`description`"},
	StatusID:    whereHelperuint64{field: "`todos`.`status_id`"},
	DueDate:     whereHelpernull_Time{field: "`todos`.`due_date`"},
	DelFlag:     whereHelperbool{field: "`todos`.`del_flag`"},
	CreateAt:    whereHelpertime_Time{field: "`todos`.`create_at`"},
	UpdateAt:    whereHelpertime_Time{field: "`todos`.`update_at`"},
}
...
type todoR struct {
	Status *TodoStatus `boil:"Status" json:"Status" toml:"Status" yaml:"Status"`
}
...
func (o *Todo) GetStatus() *TodoStatus {
	if o == nil {
		return nil
	}

	return o.R.GetStatus()
}

func (r *todoR) GetStatus() *TodoStatus {
	if r == nil {
		return nil
	}
...
var (
	todoAllColumns            = []string{"todo_id", "title", "description", "status_id", "due_date", "del_flag", "create_at", "update_at"}
	todoColumnsWithoutDefault = []string{"title", "description", "status_id", "due_date"}
	todoColumnsWithDefault    = []string{"todo_id", "del_flag", "create_at", "update_at"}
...
func (o *Todo) Status(mods ...qm.QueryMod) todoStatusQuery {
	...
	return TodoStatuses(queryMods...)
}

// LoadStatus allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (todoL) LoadStatus(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTodo interface{}, mods queries.Applicator) error {
	var slice []*Todo
	var object *Todo
	...
	query := NewQuery(
		qm.From(`todo_status`),
		qm.WhereIn(`todo_status.status_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load TodoStatus")
	}

	var resultSlice []*TodoStatus
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice TodoStatus")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for todo_status")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for todo_status")
	}
	...
	if singular {
		...
		if foreign.R == nil {
			foreign.R = &todoStatusR{}
		}
		foreign.R.StatusTodos = append(foreign.R.StatusTodos, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.StatusID == foreign.StatusID {
				...
				foreign.R.StatusTodos = append(foreign.R.StatusTodos, local)
				break
			}
		}
	}
...
// SetStatusG of the todo to the related item.
// Sets o.R.Status to related.
// Adds o to related.R.StatusTodos.
// Uses the global database handle.
func (o *Todo) SetStatusG(ctx context.Context, insert bool, related *TodoStatus) error {
	return o.SetStatus(ctx, boil.GetContextDB(), insert, related)
}

// SetStatus of the todo to the related item.
// Sets o.R.Status to related.
// Adds o to related.R.StatusTodos.
func (o *Todo) SetStatus(ctx context.Context, exec boil.ContextExecutor, insert bool, related *TodoStatus) error {
	var err error
	if insert {
	...
	values := []interface{}{related.StatusID, o.TodoID}
	...
	if related.R == nil {
		related.R = &todoStatusR{
			StatusTodos: TodoSlice{o},
		}
	} else {
		related.R.StatusTodos = append(related.R.StatusTodos, o)
	}
...
func FindTodoG(ctx context.Context, todoID uint64, selectCols ...string) (*Todo, error) {
	return FindTodo(ctx, boil.GetContextDB(), todoID, selectCols...)
}

// FindTodo retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindTodo(ctx context.Context, exec boil.ContextExecutor, todoID uint64, selectCols ...string) (*Todo, error) {
	todoObj := &Todo{}
...
func (o *Todo) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to populate default values for todos")
	}
...
func (o *Todo) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to upsert for todos")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to retrieve unique values for todos")
	}
...
func (o *Todo) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbmodels: no Todo provided for reload")
	}
...
func (o *TodoSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbmodels: empty TodoSlice provided for reload all")
	}
...
func TodoExistsG(ctx context.Context, todoID uint64) (bool, error) {
	return TodoExists(ctx, boil.GetContextDB(), todoID)
}

// TodoExists checks if the Todo row exists.
func TodoExists(ctx context.Context, exec boil.ContextExecutor, todoID uint64) (bool, error) {
	var exists bool
